...
![Hallucination intervention](results/plots/fig2_hallucination_intervention.png)
...
- `src/sakshi/epistemic_scorer.py` — distortion signal
- `src/sakshi/claim_extractor.py`, `claim_verifier.py` — claim-level verification
